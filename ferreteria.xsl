...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">  
    ...
    <body>
        <div style="width:78%;padding:10px;height:auto;border-style:solid;border-width:2px;text-align:center;font-size:50px;background-color:#c2d6d6;">Ferretería DAW</div>
        <xsl:for-each select="//categoria">
        <h2>Categoria: <xsl:value-of select="@nombre"/> (<xsl:value-of select="count(producto)"/>) productos</h2>
